            ...
            VStack {
                ...
                VStack {
                    ...
                    NavigationLink(
                        ...
                        label: {
                            SocalLoginButton(image: Image(uiImage: #imageLiteral(resourceName: "google")), text: Text("Sign in with Google").foregroundColor(Color("AccentColor")))
                                .padding(.vertical)
                        })
                    ...
                    TextField("Work email address", text: $email)
                        ...
                        .cornerRadius(50.0)
                        .shadow(color: Color.black.opacity(0.08), radius: 50, x: /*@START_MENU_TOKEN@*/0.0/*@END_MENU_TOKEN@*/, y: 16)
                        .padding(.vertical)
